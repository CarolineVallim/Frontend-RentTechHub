...
function scriptReducer(state, action) {
    ...
    switch (action.type) {
        ...
        case exports.DISPATCH_ACTION.RESET_OPTIONS:
            ...
            return __assign(__assign({}, state), { loadingStatus: exports.SCRIPT_LOADING_STATE.PENDING, options: __assign(__assign((_a = {}, _a[SDK_SETTINGS.DATA_SDK_INTEGRATION_SOURCE] = SDK_SETTINGS.DATA_SDK_INTEGRATION_SOURCE_VALUE, _a), action.value), (_b = {}, _b[SCRIPT_ID] = "".concat(getScriptID(action.value)), _b)) });
...
var PayPalScriptProvider = function (_a) {
    var _b, _c;
    var _d = _a.options, options = _d === void 0 ? { clientId: "test" } : _d, children = _a.children, _e = _a.deferLoading, deferLoading = _e === void 0 ? false : _e;
    var _f = React.useReducer(scriptReducer, {
